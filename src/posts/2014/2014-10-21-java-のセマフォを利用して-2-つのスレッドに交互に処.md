...
-   [セマフォ -
    Wikipedia](http://ja.wikipedia.org/wiki/%E3%82%BB%E3%83%9E%E3%83%95%E3%82%A9)
...
-   [Semaphore (Java Platform
    SE 6)](http://docs.oracle.com/javase/jp/6/api/java/util/concurrent/Semaphore.html)
...
-   [AbstractQueuedSynchronizer.ConditionObject (Java Platform
    SE 6)](http://docs.oracle.com/javase/jp/6/api/java/util/concurrent/locks/AbstractQueuedSynchronizer.ConditionObject.html)
-   [Condition (Java Platform SE 8
    )](http://docs.oracle.com/javase/jp/8/api/java/util/concurrent/locks/Condition.html)
...
-   [CountDownLatch (Java Platform
    SE 6)](http://docs.oracle.com/javase/jp/6/api/java/util/concurrent/CountDownLatch.html)
