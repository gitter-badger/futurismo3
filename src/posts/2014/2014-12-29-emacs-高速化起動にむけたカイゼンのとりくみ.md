...
-   [Emacs のスタートアップを視覚的に理解する -
    Qiita](http://qiita.com/yuttie/items/0f38870817c11b2166bd)
...
-   [ストレス社会を乗り切るために!cygwin と emacs
    ...
    Futurismo](http://futurismo.biz/archives/1273)
...
-   [emacs slow
    startup](http://ubuntuforums.org/showthread.php?t=183638)
...
-   [eval-after-load 設定すべきもの, hook で設定すべきもの - Life is
    very short](http://d.hatena.ne.jp/syohex/20141004/1412385064)
...
-   [Emacs - use-package で可読性の高い init.el を書く -
    Qiita](http://qiita.com/kai2nenobu/items/5dfae3767514584f5220)
-   [emacs use-package.el : Emacs の世界的権威が行っている最先端ラクラク
    init.el 整理術](http://rubikitch.com/2014/09/09/use-package/)
