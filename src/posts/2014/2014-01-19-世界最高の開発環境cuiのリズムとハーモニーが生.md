...
この観点で選んだツールたちを以下に列挙。
  ...
  * [zsh][3](Shell)
  * <span style="line-height: 1.5em;"><a href="http://www.gnu.org/software/emacs/">Emacs</a>(Editor)</span>
...
最高の開発環境を駆使しながら作業をすることは、極上の音楽の中に浸るようなものである。
 ...
 [2]: http://sicnarf.com/monsterwm-urxvt-tmux-zsh-bliss/
 [3]: http://www.zsh.org/
 [4]: http://xmonad.org/
 [5]: http://software.schmorp.de/pkg/rxvt-unicode.html
 [6]: http://tmux.sourceforge.net/
 [7]: http://save.sys.t.u-tokyo.ac.jp/~yusa/fonts/ricty.html
